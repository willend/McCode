...
def main(args):
    ...
    if default:
        ...
        run_version_test(testdir, mccoderoot, limit, instrfilter, compfilter, version, suffix)
    elif configs:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--comp', nargs="?", help='test only intruments utilising COMP. Useful for testing the instrument suite after component changes.')
