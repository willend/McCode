# Installation of McXtrace 3.5.39 on Windows 64 bit Intel systems (some support for arm64)
...
* Please use either of:
  ...
  2. **Legacy:**
    * install the legacy-style MinGW based [McXtrace 3.5.39 metapackage](https://download.mcxtrace.org/mcxtrace-3.5.39/Windows/McXtrace-Metapackage-3.5.39-win64.exe). 
