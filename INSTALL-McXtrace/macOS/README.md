# Installation of McXtrace 3.7.9 on macOS 
...
* Download the package:
  [McXtrace 3.7.9 for macOS](https://download.mcxtrace.org/mcxtrace-3.7.9/macOS/mcxtrace-3.7.9-macOS-conda.tar.gz)
 and unpack it (e.g. double-clicking should work).

* Open the relevant folder for your local processor

* Drag the McXtrace-3.7.9.app to /Applications and right-click + open to start the app:<br/>
...
* Depending on your macOS version, security settings may initially prevent the app from opening, example from macOS 15 Sequoia:
  - Initial warning that "McXtrace-3.7.9" was not opened<br/>
...
* :warning: In case the last warning still does not allow to open the application, you may issue the following command in a Terminal: `sudo xattr -dr com.apple.quarantine /Applications/McXtrace-3.7.9.app`

* McXtrace 3.7.9 macOS app bundles are fully based on conda-forge and will "self-inject" all dependencies on first launch. Please follow any on-screen instructions given.
