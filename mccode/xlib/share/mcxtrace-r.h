...
#define E2K      0.506773091264796 /* Convert E[keV] to k[1/AA] (CELE/(HBAR*M_C)*1e-10)*1e3 */
#define K2E      1.97326972808327  /* Convert k[1/AA] to E[keV] (1e10*M_C*HBAR/CELE)/1e3 */
