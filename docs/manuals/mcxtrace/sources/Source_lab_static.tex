\subsection*{X-ray tube laboratory source}
\label{s:source-lab}
...
\textbf{Source\_lab} includes a set of common anode materials: \{Cr, Co, Cu, Ga, Mo, Ag, W\}. More materials can be added by the following procedure:
\begin{enumerate}
