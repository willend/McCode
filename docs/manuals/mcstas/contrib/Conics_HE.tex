...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/contrib/Conics_HE.comp}{Source code} for \texttt{Conics\_HE.comp}.
\end{itemize}
\IfFileExists{Conics_HE_static.tex}{\input{Conics_HE_static.tex}}{}