...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/contrib/SANSCylinders.comp}{Source code} for \texttt{SANSCylinders.comp}.
\end{itemize}
\IfFileExists{SANSCylinders_static.tex}{\input{SANSCylinders_static.tex}}{}