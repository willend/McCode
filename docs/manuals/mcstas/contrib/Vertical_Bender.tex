...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/contrib/Vertical_Bender.comp}{Source code} for \texttt{Vertical\_Bender.comp}.
\end{itemize}
\IfFileExists{Vertical_Bender_static.tex}{\input{Vertical_Bender_static.tex}}{}