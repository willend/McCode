...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/contrib/Source_multi_surfaces.comp}{Source code} for \texttt{Source\_multi\_surfaces.comp}.
\end{itemize}
\IfFileExists{Source_multi_surfaces_static.tex}{\input{Source_multi_surfaces_static.tex}}{}