...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/contrib/Guide_four_side.comp}{Source code} for \texttt{Guide\_four\_side.comp}.
\end{itemize}
\IfFileExists{Guide_four_side_static.tex}{\input{Guide_four_side_static.tex}}{}