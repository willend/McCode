...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/contrib/PSD_spinDmon.comp}{Source code} for \texttt{PSD\_spinDmon.comp}.
\end{itemize}
\IfFileExists{PSD_spinDmon_static.tex}{\input{PSD_spinDmon_static.tex}}{}