...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/contrib/TOFSANSdet.comp}{Source code} for \texttt{TOFSANSdet.comp}.
\end{itemize}
\IfFileExists{TOFSANSdet_static.tex}{\input{TOFSANSdet_static.tex}}{}