...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/contrib/ViewModISIS.comp}{Source code} for \texttt{ViewModISIS.comp}.
\end{itemize}
\IfFileExists{ViewModISIS_static.tex}{\input{ViewModISIS_static.tex}}{}