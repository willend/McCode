...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/contrib/SANSSpheres.comp}{Source code} for \texttt{SANSSpheres.comp}.
\end{itemize}
\IfFileExists{SANSSpheres_static.tex}{\input{SANSSpheres_static.tex}}{}