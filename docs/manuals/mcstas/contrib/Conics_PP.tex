...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/contrib/Conics_PP.comp}{Source code} for \texttt{Conics\_PP.comp}.
\end{itemize}
\IfFileExists{Conics_PP_static.tex}{\input{Conics_PP_static.tex}}{}