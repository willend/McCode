...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/obsolete/Virtual_mcnp_ss_output.comp}{Source code} for \texttt{Virtual\_mcnp\_ss\_output.comp}.
...
\end{itemize}
\IfFileExists{Virtual_mcnp_ss_output_static.tex}{\input{Virtual_mcnp_ss_output_static.tex}}{}