...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/obsolete/ESS_moderator_short.comp}{Source code} for \texttt{ESS\_moderator\_short.comp}.
\end{itemize}
\IfFileExists{ESS_moderator_short_static.tex}{\input{ESS_moderator_short_static.tex}}{}