...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/monitors/PSDcyl_monitor.comp}{Source code} for \texttt{PSDcyl\_monitor.comp}.
\end{itemize}
\IfFileExists{PSDcyl_monitor_static.tex}{\input{PSDcyl_monitor_static.tex}}{}