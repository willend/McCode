...
k0 & AA\textasciicircum{}-1 & Numerator in k0/k weighting & 1 \\
...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/monitors/PSD_monitor_psf_eff.comp}{Source code} for \texttt{PSD\_monitor\_psf\_eff.comp}.
\end{itemize}
\IfFileExists{PSD_monitor_psf_eff_static.tex}{\input{PSD_monitor_psf_eff_static.tex}}{}