...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/monitors/Flex_monitor_2D.comp}{Source code} for \texttt{Flex\_monitor\_2D.comp}.
\end{itemize}
\IfFileExists{Flex_monitor_2D_static.tex}{\input{Flex_monitor_2D_static.tex}}{}