...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/monitors/Cyl_monitor_TOF.comp}{Source code} for \texttt{Cyl\_monitor\_TOF.comp}.
\end{itemize}
\IfFileExists{Cyl_monitor_TOF_static.tex}{\input{Cyl_monitor_TOF_static.tex}}{}