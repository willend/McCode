...
\section{Polarisation-sensitive monitors}
\index{Polarisation!monitors}

See the Polarisation chapter (\ref{c:polarization}) for the underlying
formalism; these monitors measure the projection of the polarisation
vector, either alone or resolved against wavelength/scattering angle.

\input{monitors/Pol_monitor}

\input{monitors/PolLambda_monitor}

\input{monitors/MeanPolLambda_monitor}

\input{monitors/PSD_monitor_4PI_spin}
