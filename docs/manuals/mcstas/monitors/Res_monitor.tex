...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/monitors/Res_monitor.comp}{Source code} for \texttt{Res\_monitor.comp}.
\end{itemize}
\IfFileExists{Res_monitor_static.tex}{\input{Res_monitor_static.tex}}{}