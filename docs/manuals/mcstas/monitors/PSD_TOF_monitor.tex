...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/monitors/PSD_TOF_monitor.comp}{Source code} for \texttt{PSD\_TOF\_monitor.comp}.
\end{itemize}
\IfFileExists{PSD_TOF_monitor_static.tex}{\input{PSD_TOF_monitor_static.tex}}{}