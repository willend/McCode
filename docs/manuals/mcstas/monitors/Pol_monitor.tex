...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/monitors/Pol_monitor.comp}{Source code} for \texttt{Pol\_monitor.comp}.
\end{itemize}
\IfFileExists{Pol_monitor_static.tex}{\input{Pol_monitor_static.tex}}{}