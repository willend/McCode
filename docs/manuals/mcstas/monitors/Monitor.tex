...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/monitors/Monitor.comp}{Source code} for \texttt{Monitor.comp}.
\end{itemize}
\IfFileExists{Monitor_static.tex}{\input{Monitor_static.tex}}{}