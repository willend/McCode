...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/optics/Guide_tapering.comp}{Source code} for \texttt{Guide\_tapering.comp}.
\end{itemize}
\IfFileExists{Guide_tapering_static.tex}{\input{Guide_tapering_static.tex}}{}