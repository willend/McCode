...
\subsubsection{Guide geometry and reflection}
...
\subsection*{Guide\_channeled: A guide section component with multiple channels}
...
\subsubsection{Known problems}\index{Bugs}
\begin{itemize}
...
\subsection*{Guide\_gravity: A guide with multiple channels and gravitation handling}
...
\subsection*{Bender: a bender model (non polarizing)}
