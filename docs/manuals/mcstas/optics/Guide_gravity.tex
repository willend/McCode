...
reflect & str & Reflectivity file name. Format \textless{}q(Angs-1) R(0-1)\textgreater{} & "NULL" \\
\bottomrule
\end{longtable}

\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/optics/Guide_gravity.comp}{Source code} for \texttt{Guide\_gravity.comp}.
\end{itemize}
\IfFileExists{Guide_gravity_static.tex}{\input{Guide_gravity_static.tex}}{}