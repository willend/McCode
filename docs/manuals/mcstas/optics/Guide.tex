...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/optics/Guide.comp}{Source code} for \texttt{Guide.comp}.
\end{itemize}
\IfFileExists{Guide_static.tex}{\input{Guide_static.tex}}{}