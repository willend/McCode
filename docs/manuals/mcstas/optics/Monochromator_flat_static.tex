\subsection*{An infinitely thin, flat mosaic crystal with
...
\subsubsection{Monochromator physics and algorithm}
...
According to equation~(\ref{e:probrule}), the weight adjustment $\pi_j$ is
then given by
\begin{equation}
