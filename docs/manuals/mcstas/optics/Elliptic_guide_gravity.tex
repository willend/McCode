...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/optics/Elliptic_guide_gravity.comp}{Source code} for \texttt{Elliptic\_guide\_gravity.comp}.
\end{itemize}
\IfFileExists{Elliptic_guide_gravity_static.tex}{\input{Elliptic_guide_gravity_static.tex}}{}