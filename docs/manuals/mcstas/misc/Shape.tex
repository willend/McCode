...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/misc/Shape.comp}{Source code} for \texttt{Shape.comp}.
...
\end{itemize}
\IfFileExists{Shape_static.tex}{\input{Shape_static.tex}}{}