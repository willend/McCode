...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/misc/MCPL_output.comp}{Source code} for \texttt{MCPL\_output.comp}.
\end{itemize}
\IfFileExists{MCPL_output_static.tex}{\input{MCPL_output_static.tex}}{}