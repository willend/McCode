...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/misc/Shape_simple.comp}{Source code} for \texttt{Shape\_simple.comp}.
...
\end{itemize}
\IfFileExists{Shape_simple_static.tex}{\input{Shape_simple_static.tex}}{}