...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/samples/SasView_model.comp}{Source code} for \texttt{SasView\_model.comp}.
  \item http://www.sasview.org/sasview/user/models/model\_functions.html
\end{itemize}
\IfFileExists{SasView_model_static.tex}{\input{SasView_model_static.tex}}{}