...
\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/samples/TOFRes_sample.comp}{Source code} for \texttt{TOFRes\_sample.comp}.
\end{itemize}
\IfFileExists{TOFRes_sample_static.tex}{\input{TOFRes_sample_static.tex}}{}