...
target\_index & 1 & Relative index of component to focus incoherent scattering at, e.g. next is +1 & 0 \\
\bottomrule
\end{longtable}

\subsection*{Links}
\begin{itemize}
  \item \href{run:/home/willend/willend-McCode/mcstas-comps/samples/PowderN.comp}{Source code} for \texttt{PowderN.comp}.
  ...
  \item \textless{}a href="http://www.crystallographica.com/"\textgreater{}Crystallographica\textless{}/a\textgreater{} software (free license)
...
\end{itemize}
\IfFileExists{PowderN_static.tex}{\input{PowderN_static.tex}}{}