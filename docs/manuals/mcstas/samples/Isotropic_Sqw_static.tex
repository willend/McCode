\subsection*{A general $S(q,\omega)$ coherent and incoherent scatterer}
...
V\_rho     & [\AA$^{-3}$] & atomic number density (component parameter \textit{rho}). May also be specified with molar weight \emph{weight} in [g/mol] and material \emph{density} in [g/cm$^3$] \\
