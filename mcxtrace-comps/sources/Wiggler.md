...
*McXtrace: Model of a wiggler source*
...
| K | 1 | Dimensionless undulator parameter, e.g. K >> 1. overrides B. | 3 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sources/Wiggler.comp) for `Wiggler.comp`.
