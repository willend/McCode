# The `SasView_core_shell_sphere` Component

*McXtrace: SasView core_shell_sphere model component as sample description.*
...
| sld_core | 1e-6/Ang^2 | ([-inf, inf]) core scattering length density. | 1.0 |
| sld_shell | 1e-6/Ang^2 | ([-inf, inf]) shell scattering length density. | 2.0 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_core_shell_sphere.comp) for `SasView_core_shell_sphere.comp`.
