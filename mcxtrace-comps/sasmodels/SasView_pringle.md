# The `SasView_pringle` Component

*McXtrace: SasView pringle model component as sample description.*
...
| sld | 1e-6/Ang^2 | ([-inf, inf]) Pringle sld. | 1.0 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_pringle.comp) for `SasView_pringle.comp`.
