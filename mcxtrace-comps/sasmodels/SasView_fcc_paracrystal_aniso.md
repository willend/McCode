# The `SasView_fcc_paracrystal_aniso` Component

*McXtrace: SasView fcc_paracrystal model component as sample description.*
...
| sld | 1e-6/Ang^2 | ([-inf, inf]) Particle scattering length density. | 4 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_fcc_paracrystal_aniso.comp) for `SasView_fcc_paracrystal_aniso.comp`.
