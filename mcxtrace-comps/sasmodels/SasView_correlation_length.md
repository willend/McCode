# The `SasView_correlation_length` Component

*McXtrace: SasView correlation_length model component as sample description.*
...
| cor_length | Ang | ([0, inf]) Correlation length, xi, in Lorentzian. | 50.0 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_correlation_length.comp) for `SasView_correlation_length.comp`.
