# The `SasView_gel_fit` Component

*McXtrace: SasView gel_fit model component as sample description.*
...
|------|------|-------------|---------|
| guinier_scale | cm^-1 | ([-inf, inf]) Guinier term scale. | 1.7 |
| lorentz_scale | cm^-1 | ([-inf, inf]) Lorentz term scale. | 3.5 |
| rg | Ang | ([2, inf]) Radius of gyration. | 104.0 |
| fractal_dim |  | ([0, inf]) Fractal exponent. | 2.0 |
| cor_length | Ang | ([0, inf]) Correlation length. | 16.0 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_gel_fit.comp) for `SasView_gel_fit.comp`.
