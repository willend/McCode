# The `SasView_gaussian_peak` Component

*McXtrace: SasView gaussian_peak model component as sample description.*
...
|------|------|-------------|---------|
| peak_pos | 1/Ang | ([-inf, inf]) Peak position. | 0.05 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_gaussian_peak.comp) for `SasView_gaussian_peak.comp`.
