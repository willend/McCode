# The `SasView_guinier` Component

*McXtrace: SasView guinier model component as sample description.*
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_guinier.comp) for `SasView_guinier.comp`.
