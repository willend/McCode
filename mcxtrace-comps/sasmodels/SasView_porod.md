# The `SasView_porod` Component

*McXtrace: SasView porod model component as sample description.*
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_porod.comp) for `SasView_porod.comp`.
