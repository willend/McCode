# The `SasView_barbell` Component

*McXtrace: SasView barbell model component as sample description.*
...
|------|------|-------------|---------|
| sld | 1e-6/Ang^2 | ([-inf, inf]) Barbell scattering length density. | 4 |
| sld_solvent | 1e-6/Ang^2 | ([-inf, inf]) Solvent scattering length density. | 1 |
| radius_bell | Ang | ([0, inf]) Spherical bell radius. | 40 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_barbell.comp) for `SasView_barbell.comp`.
