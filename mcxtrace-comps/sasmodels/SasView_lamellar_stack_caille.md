# The `SasView_lamellar_stack_caille` Component

*McXtrace: SasView lamellar_stack_caille model component as sample description.*
...
| d_spacing | Ang | ([0.0, inf]) lamellar d-spacing of Caille S(Q). | 400.0 |
| Caille_parameter | 1/Ang^2 | ([0.0, 0.8]) Caille parameter. | 0.1 |
| sld | 1e-6/Ang^2 | ([-inf, inf]) layer scattering length density. | 6.3 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_lamellar_stack_caille.comp) for `SasView_lamellar_stack_caille.comp`.
