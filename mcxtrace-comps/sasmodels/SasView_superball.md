# The `SasView_superball` Component

*McXtrace: SasView superball model component as sample description.*
...
|------|------|-------------|---------|
| sld | 1e-6/Ang^2 | ([-inf, inf]) Superball scattering length density. | 4 |
| sld_solvent | 1e-6/Ang^2 | ([-inf, inf]) Solvent scattering length density. | 1 |
| length_a | Ang | ([0, inf]) Cube edge length of the superball. | 50 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_superball.comp) for `SasView_superball.comp`.
