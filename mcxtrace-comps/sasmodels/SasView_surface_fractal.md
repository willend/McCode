# The `SasView_surface_fractal` Component

*McXtrace: SasView surface_fractal model component as sample description.*
...
| cutoff_length | Ang | ([0.0, inf]) Cut-off Length. | 500.0 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_surface_fractal.comp) for `SasView_surface_fractal.comp`.
