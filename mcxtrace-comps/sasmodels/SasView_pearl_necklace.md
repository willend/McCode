# The `SasView_pearl_necklace` Component

*McXtrace: SasView pearl_necklace model component as sample description.*
...
| edge_sep | Ang | ([0, inf]) Mean separation of chained particles. | 350.0 |
| thick_string | Ang | ([0, inf]) Thickness of the chain linkage. | 2.5 |
| num_pearls | none | ([1, inf]) Number of pearls in the necklace (must be integer). | 3 |
| sld | 1e-6/Ang^2 | ([-inf, inf]) Scattering length density of the chained spheres. | 1.0 |
| sld_string | 1e-6/Ang^2 | ([-inf, inf]) Scattering length density of the chain linkage. | 1.0 |
| sld_solvent | 1e-6/Ang^2 | ([-inf, inf]) Scattering length density of the solvent. | 6.3 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_pearl_necklace.comp) for `SasView_pearl_necklace.comp`.
