# The `SasView_multilayer_vesicle` Component

*McXtrace: SasView multilayer_vesicle model component as sample description.*
...
| thick_shell | Ang | ([0.0, inf]) thickness of one shell. | 10.0 |
| thick_solvent | Ang | ([0.0, inf]) solvent thickness between shells. | 10.0 |
| sld_solvent | 1e-6/Ang^2 | ([-inf, inf]) solvent scattering length density. | 6.4 |
| sld | 1e-6/Ang^2 | ([-inf, inf]) Shell scattering length density. | 0.4 |
...
| pd_thick_solvent |  | (0,inf) defined as (dx/x), where x is de mean value and dx the standard devition of the variable | 0.0 |

## Links

- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_multilayer_vesicle.comp) for `SasView_multilayer_vesicle.comp`.
