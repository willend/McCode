# The `SasView_parallelepiped_aniso` Component

*McXtrace: SasView parallelepiped model component as sample description.*
...
|------|------|-------------|---------|
| sld | 1e-6/Ang^2 | ([-inf, inf]) Parallelepiped scattering length density. | 4 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_parallelepiped_aniso.comp) for `SasView_parallelepiped_aniso.comp`.
