# The `SasView_binary_hard_sphere` Component

*McXtrace: SasView binary_hard_sphere model component as sample description.*
...
|------|------|-------------|---------|
| radius_lg | Ang | ([0, inf]) radius of large particle. | 100 |
| radius_sm | Ang | ([0, inf]) radius of small particle. | 25 |
| volfraction_lg |  | ([0, 1]) volume fraction of large particle. | 0.1 |
| volfraction_sm |  | ([0, 1]) volume fraction of small particle. | 0.2 |
| sld_lg | 1e-6/Ang^2 | ([-inf, inf]) scattering length density of large particle. | 3.5 |
| sld_sm | 1e-6/Ang^2 | ([-inf, inf]) scattering length density of small particle. | 0.5 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_binary_hard_sphere.comp) for `SasView_binary_hard_sphere.comp`.
