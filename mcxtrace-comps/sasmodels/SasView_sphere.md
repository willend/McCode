# The `SasView_sphere` Component

*McXtrace: SasView sphere model component as sample description.*
...
|------|------|-------------|---------|
| sld | 1e-6/Ang^2 | ([-inf, inf]) Layer scattering length density. | 1 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_sphere.comp) for `SasView_sphere.comp`.
