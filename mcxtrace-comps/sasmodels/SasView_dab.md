# The `SasView_dab` Component

*McXtrace: SasView dab model component as sample description.*
...
|------|------|-------------|---------|
| cor_length | Ang | ([0, inf]) correlation length. | 50.0 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_dab.comp) for `SasView_dab.comp`.
