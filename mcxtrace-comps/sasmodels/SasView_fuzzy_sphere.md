# The `SasView_fuzzy_sphere` Component

*McXtrace: SasView fuzzy_sphere model component as sample description.*
...
|------|------|-------------|---------|
| sld | 1e-6/Ang^2 | ([-inf, inf]) Particle scattering length density. | 1 |
| sld_solvent | 1e-6/Ang^2 | ([-inf, inf]) Solvent scattering length density. | 3 |
| radius | Ang | ([0, inf]) Sphere radius. | 60 |
| fuzziness | Ang | ([0, inf]) std deviation of Gaussian convolution for interface (must be << radius). | 10 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_fuzzy_sphere.comp) for `SasView_fuzzy_sphere.comp`.
