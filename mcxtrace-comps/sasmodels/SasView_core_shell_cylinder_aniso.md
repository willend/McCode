# The `SasView_core_shell_cylinder_aniso` Component

*McXtrace: SasView core_shell_cylinder model component as sample description.*
...
| sld_shell | 1e-6/Ang^2 | ([-inf, inf]) Cylinder shell scattering length density. | 4 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_core_shell_cylinder_aniso.comp) for `SasView_core_shell_cylinder_aniso.comp`.
