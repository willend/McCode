# The `SasView_core_shell_bicelle_elliptical_aniso` Component

*McXtrace: SasView core_shell_bicelle_elliptical model component as sample description.*
...
| thick_rim | Ang | ([0, inf]) Rim shell thickness. | 8 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/sasmodels/SasView_core_shell_bicelle_elliptical_aniso.comp) for `SasView_core_shell_bicelle_elliptical_aniso.comp`.
