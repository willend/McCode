...
*McXtrace: Sample model handling absorption, fluorescence, Compton and Rayleigh scattering.*
...
| flag_low_z | 1 | When 1, enhances low concentration atoms, else uses cross-sections weighting. | 0 |
| order | 1 | Limit multiple fluorescence up to given order. Last iteration is absorption only. | 1 |

## Links

- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/samples/Fluorescence.comp) for `Fluorescence.comp`.
