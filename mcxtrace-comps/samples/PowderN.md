...
*McXtrace: General powder sample (N lines, single scattering, incoherent scattering)*
...
| delta_d_d | 1 | Global relative Delta_d/d spreading when the 'w' column is not available. Use 0 if ideal. | 0 |
...
| barns | 1 | Flag to indicate if \|F\|^2 from 'reflections' is in barns or fm^2, (barns=1 for laz/cif, barns=0 for lau type files). | 1 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/samples/PowderN.comp) for `PowderN.comp`.
