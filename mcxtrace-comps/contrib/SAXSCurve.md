# The `SAXSCurve` Component

*McXtrace: A component mimicking the scattering from a given I(q)-curve by using
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/contrib/SAXSCurve.comp) for `SAXSCurve.comp`.
