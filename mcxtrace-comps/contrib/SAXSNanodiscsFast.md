# The `SAXSNanodiscsFast` Component
...
```text
A component very similar to SAXSNanodiscs.comp - however, the scattering
profile is only computed once, and linear interpolation is then used to
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/contrib/SAXSNanodiscsFast.comp) for `SAXSNanodiscsFast.comp`.
