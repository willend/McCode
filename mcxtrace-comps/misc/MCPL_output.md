...
*McXtrace: Detector-like component that writes photon state parameters into an mcpl-format
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/misc/MCPL_output.comp) for `MCPL_output.comp`.
