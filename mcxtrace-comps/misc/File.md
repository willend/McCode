...
*McXtrace: File.comp - allows to generate instrument/component input-files
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/misc/File.comp) for `File.comp`.
