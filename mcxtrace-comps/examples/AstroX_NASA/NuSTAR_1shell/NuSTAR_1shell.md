...
| FLd | m | The distance from the optics centre to the detector. If 0 the detector is placed at the focal plane. | 0 |
...
| drx | arcsec | Rotation of shell along X | 0 |
| dry | arcsec | Rotation of shell along Y | 0 |
| drz | arcsec | Rotation of shell along Z | 0 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcxtrace-comps/examples/AstroX_NASA/NuSTAR_1shell/NuSTAR_1shell.instr) for `NuSTAR_1shell.instr`.
