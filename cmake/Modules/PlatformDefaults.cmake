...
function( detect_platform_variables resultvarname )
  ...
  if ( NOT NEXUSFLAGS )
    ...
    if ( WINDOWS )
      if ( "${CMAKE_C_COMPILER_ID}" STREQUAL "MSVC" )
        set( NEXUSFLAGS "/I\$\{CONDA_PREFIX\}/Library/include/nexus /link /LIBPATH:\$\{CONDA_PREFIX\}/Library/lib NeXus.lib" )
      else()
	set( NEXUSFLAGS "-I\$\{CONDA_PREFIX\}/Library/include/nexus -Wl,-rpath,$\{CONDA_PREFIX\}/Library/lib -L\$\{CONDA_PREFIX\}/Library/lib -lNeXus" )
      endif()
    endif()
    if ( NEXUSLIB )
