# Installation of McStas 3.8.4 on Windows 64 bit Intel systems (some support for arm64)
...
* As **Administrator**, run our new  [`install_msvc_for_conda.bat`](install_msvc_for_conda.bat) batch script to install MSVC and required packages to your system. Alternatively, [install MSVC manually](VScode_manual_install)
* Please remove any existing MinGW-based version of McStas 3.8.4 before proceeding!
* install the new MSVC based [McStas 3.8.4 MSVC metapackage](https://download.mcstas.org/mcstas-3.8.4/Windows/MSVC/McStas-Metapackage-3.8.4-MSVC-win64.exe)
...
* Please remove any MSVC-based version of McStas 3.8.4 before proceeding!
* install the legacy-style MinGW based [McStas 3.8.4 MinGW metapackage](https://download.mcstas.org/mcstas-3.8.4/Windows/MinGW/McStas-Metapackage-3.8.4-MinGW-win64.exe)
