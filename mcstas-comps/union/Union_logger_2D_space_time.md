# The `Union_logger_2D_space_time` Component

*McStas: Two dimensional spatail logger for a number of time bins*
...
| D2_min | m | Histogram boundery, min position value for second axis | -5 |
| D2_max | m | Histogram boundery, max position value for second axis | 5 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcstas-comps/union/Union_logger_2D_space_time.comp) for `Union_logger_2D_space_time.comp`.
