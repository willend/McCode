...
*McStas: A box geometry component for the Union components*
...
| minus_y_surface | string | Comma seperated string of Union surface definitions defined prior to this component, applied to -z face of box | 0 |
