...
- [Source code](ESS_butterfly_tfocus_NOFOCUS_test.instr) for `ESS_butterfly_tfocus_NOFOCUS_test.instr`.
- [Additional information](ESS_butterfly_tfocus_NOFOCUS_test.md) (only if available!)
- <reference/HTML link>
