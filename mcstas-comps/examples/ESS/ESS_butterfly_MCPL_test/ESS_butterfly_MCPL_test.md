...
*McStas: Test instrument for the updated BF1 butterfly moderator design using MCPL input*
...
| index | 1 | Target index for source focusing. Defaults to illuminate the "cold collimated" brilliance monitor, thereby suppressing "dist" | 8 |
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcstas-comps/examples/ESS/ESS_butterfly_MCPL_test/ESS_butterfly_MCPL_test.instr) for `ESS_butterfly_MCPL_test.instr`.
- <reference/HTML link>
