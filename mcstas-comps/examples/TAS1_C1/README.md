# The `TAS1_C1` Instrument

*McStas: Example formerly known as linup-1.instr
...
| C1 | arcmin | C1 collimation | 30 |

## Links

- [Source code](TAS1_C1.instr) for `TAS1_C1.instr`.
- [Additional information](TAS1_C1.md) (only if available!)
