# The `SNS_ARCS_Mantid` Instrument

*McStas: Model of the ARCS spectrometer from SNS with Mantid support.*
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcstas-comps/examples/Mantid/SNS_ARCS_Mantid/SNS_ARCS_Mantid.instr) for `SNS_ARCS_Mantid.instr`.
