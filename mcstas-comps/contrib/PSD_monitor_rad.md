...
*McStas: Position-sensitive monitor with radially averaging.*
...
- [Source code](/Users/peterwillendrup/Projects/willend-McCode/mcstas-comps/contrib/PSD_monitor_rad.comp) for `PSD_monitor_rad.comp`.
